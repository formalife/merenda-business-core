...
**Elaborazione semantica del batch 126–150 — 12/25 completati; continuare dal contenuto 138.**

## Corpus

- Video individuati: 468
- Contenuti processati semanticamente: 137
- STUDIATO / integrati nella KB: 131
...
- Elaborazione semantica 126–150: 12/25 completati
...
`ddb6CBRIYiU` — *MARKETING | Il CORAGGIO di essere DIFFERENTI per demolire la concorrenza* — `04_marketing`.
...
`ddb6CBRIYiU` — *MARKETING | Il CORAGGIO di essere DIFFERENTI per demolire la concorrenza* — `04_marketing` — posizione 138.

...
**Elaborazione semantica del batch 126–150 — 11/25 completati; continuare dal contenuto 137.**

## Corpus

- Video individuati: 468
- Contenuti processati semanticamente: 136
- STUDIATO / integrati nella KB: 130
...
- Elaborazione semantica 126–150: 11/25 completati
...
`kNAdI1VyIJU` — *MARKETING a Risposta Diretta VS Marketing Istituzionale [Idiozia]* — `04_marketing`.
...
`kNAdI1VyIJU` — *MARKETING a Risposta Diretta VS Marketing Istituzionale [Idiozia]* — `04_marketing` — posizione 137.
